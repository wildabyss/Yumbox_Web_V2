...
(function ($) {
    ...
    StripeAccount.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl:
            ...
            '<h2>Representer information <span id="representer_verification"></span></h2>'+
            ...
            '<div class="editable-stripe-account"><span>Birthday: </span>'+
                '<span class="birthday">Year: </span><input type="number" name="year" min="1900" max="2010" class="input-small">'+
                '<span class="birthday">Month: </span><input type="number" name="month" min="1" max="12" class="input-small">'+
                '<span class="birthday">Day: </span><input type="number" name="day" min="1" max="31" class="input-small">'+
            '</div>'+
            '<div class="editable-stripe-account"><span>SIN number: </span><input type="text" name="pii" class="input-small"></div>'+

            '<h2>Bank account information <span id="bank_account_verification"></span></h2>'+
